...
const sourcePath = path.join(rootDir, "pdf", "templates", "opening-checklist.html");
const outputDir = path.join(rootDir, "docs", "operational-records", "checklists");
const outputPath = path.join(outputDir, "opening-checklist-ribbai.pdf");
  ...
  await page.pdf({
    ...
    footerTemplate: `
      <div style="font-family: Arial, sans-serif; font-size: 8px; color: #687085; width: 100%; padding: 0 13mm; display: flex; justify-content: space-between;">
        <span>RIBBAI OPS · Checklist de Abertura</span>
