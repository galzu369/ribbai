...
const defaultHtmlPath = path.join(
  ...
  "reports",
  "monthly",
  "relatorio-executivo-mensal-ribbai-junho-2026.html"
);
...
const defaultPdfPath = path.join(
  ...
  "reports",
  "monthly",
  "relatorio-executivo-mensal-ribbai-junho-2026.pdf"
);
...
try {
  ...
  await page.pdf({
    ...
    footerTemplate: `
      <div style="font-family: Arial, sans-serif; font-size: 8px; color: #657085; width: 100%; padding: 0 13mm; display: flex; justify-content: space-between;">
        <span>RIBBAI 2.0 · Relatório Executivo Mensal · Junho 2026</span>
  ...
  console.warn(`Monthly Executive PDF generated: ${pdfPath}`);
} finally {
  await browser.close();
}
