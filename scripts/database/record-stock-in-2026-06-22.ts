...
const REFERENCE_ID = "STOCK-IN-2026-06-22-CHEIRO-BOXPOKE";
const REFERENCE_TYPE = "SUPPLIER_DELIVERY";
const TRANSACTION_DATE = new Date("2026-06-22T12:00:00.000Z");
...
const STOCK_IN_LINES: StockInLine[] = [
  {
    ...
    notes: "Reposicao de stock de Cheiro Urinol.",
  },
  {
    ...
    notes: "Reposicao de stock de box POKE + tampas.",
  },
];
    ...
    await prisma.$transaction([
      ...
      prisma.inventoryTransaction.create({
        data: {
          ...
          reason: "Entrada de stock de consumiveis (Cheiro Urinol e Box POKE + tampas).",
          notes: lineNotes,
          createdBy: CREATED_BY,
