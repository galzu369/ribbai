...
const REFERENCE_ID = "STOCK-IN-2026-06-16-SAUCE-RESTOCK";
const REFERENCE_TYPE = "SUPPLIER_DELIVERY";
const TRANSACTION_DATE = new Date("2026-06-16T12:00:00.000Z");
...
const STOCK_IN_LINES: StockInLine[] = [
  {
    ...
    unitCost: new Prisma.Decimal("17.80"),
    minimumStock: new Prisma.Decimal("0.25"),
    reorderPoint: new Prisma.Decimal("0.25"),
  },
  {
    sku: "SAUCE-KETCHUP",
    name: "Ketchup",
    ...
    unitCost: new Prisma.Decimal("18.61"),
    ...
    await prisma.$transaction([
      ...
      prisma.inventoryTransaction.create({
        data: {
          ...
          reason: "Entrada de stock (reposicao de molhos)",
          notes: `Entrada em ${REFERENCE_ID}: ${formatDecimal(line.quantity)} ${line.unit} a ${formatCurrency(
            line.unitCost
          )}/${line.unit}.`,
