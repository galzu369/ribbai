...
const REFERENCE_ID = "STOCK-IN-2026-06-20-WC-HAND-PAPER";
const REFERENCE_TYPE = "SUPPLIER_DELIVERY";
const TRANSACTION_DATE = new Date("2026-06-20T12:00:00.000Z");
...
const STOCK_IN_LINES: StockInLine[] = [
  {
    ...
    unitCost: new Prisma.Decimal("14"),
    minimumStock: new Prisma.Decimal("1"),
    reorderPoint: new Prisma.Decimal("1"),
    notes:
      "Reposicao de stock para garantir cobertura operacional das casas de banho e eliminar risco de rutura. Conversao interna: 1 caixa = 20 sacos (total recebido: 80 sacos).",
  },
];
    ...
    await prisma.$transaction([
      ...
      prisma.inventoryTransaction.create({
        data: {
          ...
          reason: "Entrada de stock de Papel de Maos WC para cobertura operacional",
          notes: lineNotes,
          createdBy: CREATED_BY,
